...
namespace StudentUnitTestProject
{
    ...
    public partial class MainTest : TestBase
    {
        ...
        public void GetDelimitedAndJsonWithFullPath()
        {
            ...
            Debug.WriteLine(string.Join(" | ", delimitedFiles.Select(current => Path.GetFileName(current.Name))));
        ...
        public void RemoteFolderExists()
        {
        ...
        public void ReadJsonFile()
        {
            ...
            Assert.AreEqual(
                Operations.ReadJsonFile("applications.json").Count, 10,
                $"Expected {expected} lines in {nameof(ReadJsonFile)}");
        }
