...
:large_orange_diamond: [Source code](https://github.com/karenpayneoregon/ImportingCsvFiles1/blob/master/Example1Library/Classes/FileOperations.cs) is simila to this repo with severa improvements.
